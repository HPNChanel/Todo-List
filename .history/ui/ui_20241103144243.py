...
class TaskAppUI:
    ...
    def create_action_button(self):
        ...
        self.complete_task.grid(row=0, column=0, padx=5, pady=5)
        
        self.delele_task = tk.Button(button_frame, text="Delete Task", command=self.delele_task, width=15, bg="#EF5350")
