...
def create_ui():
  ...
  def update_task_list():
    task_listbox.delete(0, tk.END)  #! delete(0, tk.END) is used to clear the contents of a widget, such as Entry or Listbox, tk.END represents the end of a widget's content
    tasks = get_all_tasks()
    for task in tasks: 
